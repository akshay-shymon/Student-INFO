...
<div class="w3-banner-edu">
   ...
   <div class="w3l_header_left">
				<ul>
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mail@santhigiricollege.com">mail@santhigiricollege.com</a></li>
				</ul>
			</div>
			<div class="w3l_header_right">
				<div class="w3ls-social-icons text-left">
					<a class="facebook" href="https://www.facebook.com/SanthigiriCollege/"><i class="fa fa-facebook"></i></a>
					<a class="twitter" href="https://twitter.com/sancollege"><i class="fa fa-twitter"></i></a>
					<!--<a class="pinterest" href="#"><i class="fa fa-pinterest-p"></i></a>-->
					<a class="linkedin" href="https://in.linkedin.com/school/santhigiri-college-of-computer-sciences-vazhithala-p.o.-thodupuzha-685-583/"><i class="fa fa-linkedin"></i></a>
				</div>
			</div>
   ...
   <div class="agileits_w3layouts_banner_nav">
			<nav class="navbar navbar-default">
				...
				<h1><a class="navbar-brand" href="index.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i><span>Student Info</span></a></h1>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							...
							<li><a href="stu_all_details.php" >Register</a></li>

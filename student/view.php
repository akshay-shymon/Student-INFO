...
{ 
		...
		$result=mysqli_query($con,"select * from tbl_stu_all_details a,tbl_basicinfo b where b.student_id='$username' && a.student_id='$username' ");
		...
		$result4=mysqli_query($con,"select * from tbl_course where course_id='$row[course_id]'");
		$row4=mysqli_fetch_array($result4);
		
		$result5=mysqli_query($con,"select * from tbl_batch where batch_id='$row[batch_id]'");
                	...
                	<div class="form-horizontal">
						...
						<div class="form-group" style="margin-top:10px;">
                        		<label class="control-label col-sm-2" for="txtstuname">Name</label>
                        			<div class="col-sm-10">
                           				<input type="text" name="txtstuname" value="<?php echo $row['name'] ?>" style="width:500px;" required>
                        			</div>
                    	</div>
                        <div class="form-group" style="margin-top:10px;">
                         <label class="control-label col-sm-2" for="txtstuname">Course</label>
                        			<div class="col-sm-10">
                           				<input type="text" name="txtstuname" value="<?php echo $row4['course_name'] ?>" style="width:500px;" required>
                        			</div>
								<!--
                                </div>-->
                       ...
                       <div class="form-group" style="margin-top:10px;">
                        	<label class="control-label col-sm-2" for="txtstuname">Batch</label>
                        			<div class="col-sm-10">
                           				<input type="text" name="txtemail" value="<?php echo $row5['batch'] ?>" style="width:500px;" required>
                        			</div>		
                        ...
                        <div class="form-group" style="margin-top:10px;">
                        		<label class="control-label col-sm-2" for="txtstuname">Email</label>
                        			<div class="col-sm-10">
                           				<input type="text" name="txtemail" value="<?php echo $row['email'] ?>" style="width:500px;" required>
                        			</div>
                    <div class="form-group" style="margin-top:10px;">
                        		 <h3 style="text-align: center">Parent</h3>
                      </div>
             		<input type="hidden" name="txtstudent" value="<?php echo $username?>">
						<div class="form-group" style="margin-top:10px;">

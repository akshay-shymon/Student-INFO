...
include("config.php");
?>
<form action="religion_filter_dept_view.php" method="post">

<div class="container" style="margin-left:250px;">
   	<div class="row">
            <div class="col-md-11" style="box-shadow: 2px 2px 10px #1b93e1; border-radius: 4px; top: 14px;"><br><br>
                <h3 style="text-align: center"> FILTER RELIGION</h3>
...
if(isset($_POST["sub"]))
{
	    $religion_id=$_POST["religionselect"];
}else
echo 'failed';

		?>
        <input type="hidden" name="religionselect" value="<?php echo $religion_id ?>">
                        <div class="form-group" style="margin-top:10px;">
                         <div class="col-sm-10">
                        		<tr>
								<td>Select Department</td><br>

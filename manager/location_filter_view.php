...
?>
<div class="btn">
            <form action="location_filter_class_view_xl.php" method="post">
            <input type="hidden" name="course" value ="<?php  echo $course ?>">
            <input type="hidden" name="batch" value ="<?php  echo $batch ?>">
                <button type="submit" id="btnExport"
                    name='export' value="<?php  echo $location ?>"
...
if(isset($_POST["btnSave"]))
{
		...
		$location=$_POST["locationselect"];
                            ...
                            $slno=1;
							$result=mysqli_query($con,"select * from tbl_basicinfo a,tbl_stu_all_details b where a.course_id='$course' && a.batch_id='$batch' && b.location_id='$location' && a.student_id=b.student_id");

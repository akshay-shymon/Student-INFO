                ...
                <h3 style="text-align: center">FILTER STUDENT</h3>
                		<div class="form-horizontal" style="margin-left:250px;">
                            ...
                            <div class="form-group" style="margin-top:10px;">
                        		<label class="control-label col-sm-2" for="short_name">12Th mark in (%)</label>
                        			<div class="col-sm-10">
                        ...
                        <div class="form-group" style="margin-top:10px;">
                        		...
                        		<input type="submit" name="sub" value="College" formaction="12mark_filter_college.php">

                    	</div>
                                                <div class="form-group" style="margin-top:10px;">
                        		<label class="control-label col-sm-2" for="txtfathername">Class</label>
                        		<input type="submit" name="sub" value="Class" formaction="12mark_filter_class.php">

                    	</div>
                        <div class="form-group" style="margin-top:10px;">
                        		<label class="control-label col-sm-2" for="txtfathername">Department</label>
                        		<input type="submit" name="sub" value="Department" formaction="12mark_filter_dept.php">

                    	</div>
                        <div class="form-group" style="margin-top:10px;">
                        		<label class="control-label col-sm-2" for="txtfathername">Batch</label>
                        		<input type="submit" name="sub" value="Batch" formaction="12mark_filter_batch.php" >

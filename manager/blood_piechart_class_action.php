      ...
      <head>    
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          { 
						  $loc_id=$row['b_id'];
						    $sql=mysqli_query($con,"select count(*) from tbl_stu_all_details a,tbl_basicinfo b where a.location_id='$loc_id' && a.student_id=b.student_id && course_id='$course' && batch_id='$batch' && approve=1");

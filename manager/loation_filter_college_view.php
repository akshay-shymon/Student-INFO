...
<div class="btn">
            <form action="location_filter_college_view_xl.php" method="post">
...
if(isset($_POST["sub"]))
{
		...
		$location=$_POST["locationselect"];
                            ...
                            $slno=1;
							$result=mysqli_query($con,"select * from tbl_basicinfo a,tbl_stu_all_details b where b.location_id='$location' && a.student_id=b.student_id && approve=1");

...
<div class="btn">
            <form action="10mark_filter_dept_view_xl.php" method="post">
...
if(isset($_POST["btnSave"]))
{
		...
		$tenmark=$_POST["tenmarkget"];
                            ...
                            $slno=1;
							$result=mysqli_query($con,"select * from tbl_basicinfo a,tbl_stu_all_details b where a.course_id='$course' && b.10th_result > '$tenmark' && a.student_id=b.student_id");

...
<div class="btn">
            <form action="loation_filter_dept_view_xl.php" method="post">
            <input type="hidden" name="course" value="<?php echo $course;?>">
                <button type="submit" id="btnExport" name="export" value="<?php  echo $course ?>" class="btn btn-info"  style="width:85px; height:35px;">Export</button>
            </form>   
        </div>
        </div>
...
if(isset($_POST["btnSave"]))
{
		...
		$location=$_POST["locationselect"];
                            ...
                            $slno=1;
							$result=mysqli_query($con,"select * from tbl_basicinfo a,tbl_stu_all_details b where  a.course_id='$course' && b.location_id='$location' && a.student_id=b.student_id");

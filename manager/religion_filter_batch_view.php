...
<div class="btn">
            <form action="religion_filter_batch_view_xl.php" method="post">
...
if(isset($_POST["btnSave"]))
{
		...
		$religion=$_POST["religionselect"];
                            ...
                            $slno=1;
							$result=mysqli_query($con,"select * from tbl_basicinfo a,tbl_stu_all_details b where  a.batch_id='$batch' && b.religion_id='$religion' && a.student_id=b.student_id");

...
<div class="btn">
            <form action="12mark_filter_batch_view_xl.php" method="post">
...
if(isset($_POST["btnSave"]))
{
		...
		$tenmark=$_POST["tenmark"];
                            ...
                            $slno=1;
							$result=mysqli_query($con,"select * from tbl_basicinfo a,tbl_stu_all_details b where  a.batch_id='$batch' && a.student_id=b.student_id && b.12th_result > '$tenmark'");

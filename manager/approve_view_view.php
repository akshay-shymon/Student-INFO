                      ...
                      <h3 style="text-align: center">10th result and school</h3>
                       ...
                       <br><br>
                        ...
                        <div class="col-sm-6">
                         		...
                         		<div class="col-sm-6">
                        				<input type="submit" name ="btnSave" formaction="approve_action.php" value="Approve" class="btn btn-danger" style="width:65px; height:35px;">
                    	</div>
                        <div class="col-sm-6"><br><br>
                        				<input type="submit" name ="btnSave" formaction="rejact_action.php" value="Rjact" class="btn btn-danger" style="width:65px; height:35px;">
                    	</div>
                        		</div>
                        </div>
					</div>

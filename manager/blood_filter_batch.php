...
if(isset($_POST["sub"]))
{
	    $blood_id=$_POST["bloodselect"];
}else
echo 'failed';

		?>
        <input type="hidden" name="bloodselect" value="<?php echo $blood_id ?>">

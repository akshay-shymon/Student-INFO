...
<div class="btn">
            <form action="religion_filter_view_xl.php" method="post">
            <input type="hidden" name="txtcourse" value="<?php  echo $course ?>">
            <input type="hidden" name="txtbatch" value="<?php  echo $batch ?>">
...
if(isset($_POST["btnSave"]))
{
		...
		$religion=$_POST["religionselect"];
                            ...
                            $slno=1;
							$result=mysqli_query($con,"select * from tbl_basicinfo a,tbl_stu_all_details b where a.course_id='$course' && a.batch_id='$batch' && b.religion_id='$religion' && a.student_id=b.student_id");

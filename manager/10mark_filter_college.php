...
<div class="btn">
            <form action="10mark_filter_college_view_xl.php" method="post">
...
if(isset($_POST["sub"]))
{
		...
		$tenmark=$_POST["tenmark"];
                            ...
                            $slno=1;
							$result=mysqli_query($con,"select * from tbl_basicinfo a,tbl_stu_all_details b where b.10th_result > '$tenmark' && a.student_id=b.student_id");
